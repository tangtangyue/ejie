	...
	<body>
		...
		<div class="admin-content">
			<div class="admin-content-body">
				...
				<div class="am-g">
					<form class="am-form am-form-horizontal" action="<%=basePath %>mtype/save" method="post" 
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder="请输入菜饮类型" 
									name="tname"  data-equal-to="doc-vld-pwd-1"  required> <small>输入菜饮类型。</small>
							</div>
